...
import bidyourride.kurama.com.eapaka.fragment.CommentFragment;
import bidyourride.kurama.com.eapaka.helper.GoogleMapHelper;
import bidyourride.kurama.com.eapaka.helper.ObjectWrapperForBinder;
...
import bidyourride.kurama.com.eapaka.model.PolylineObject;
import bidyourride.kurama.com.eapaka.model.RequestBid;
import bidyourride.kurama.com.eapaka.model.RideRequest;
import bidyourride.kurama.com.eapaka.model.RouteObject;
import bidyourride.kurama.com.eapaka.model.StepsObject;
...
import bidyourride.kurama.com.eapaka.viewholder.RideRequestBidViewHolder;
...
public class RideDetailsActivity extends BaseActivity implements OnMapReadyCallback, View.OnClickListener, View.OnTouchListener {
    ...
    private void hideBidButtonForRequesterAndTopBidsForOthers(Boolean calledAfterClickingTryAgain) {
        if (calledAfterClickingTryAgain) {
            if (bidLayout.getVisibility() == View.GONE) {
                ...
                String maxValueToBid = "$" + String.valueOf(minValueFromWholeBidding);
                priceView.setText(maxValueToBid);
    ...
    private void hideBidButtonForBidderAndShowHisPreviousBidAfterPosting(String uid, Double previousBidByYou) {
        ...
        if (minValueFromWholeBidding < previousBidByYou) {
            ...
            s = "Someone submitted a bid for even lower amount:" + concatString ;
